...
index_array=zeros; %array to store index of pixels falling in a particular segemnt
j=1; %counter
...
%     end
    ...
    %store individual bits from LSB in temp# variable
...
%     end
    ...
    num1_bin=dec2bin(num1);
    num2_bin=dec2bin(num2);
    %steps explained in previous segment
    temp1=num1_bin(numel(num1_bin));
    temp2=num1_bin(numel(num1_bin)-1);
    temp3=num1_bin(numel(num1_bin)-2);
